...
contract('ChainList', function (accounts) {
    ...
    it("should let us sell a first article", async () => {
        ...
        articleId = articlesForSale[0].toNumber();
    ...
    it("should let us sell a second article", async () => {
        const receipt = await chainListInstance.sellArticle(articleName2, articleDescription2, web3.utils.toWei(articlePrice2, "ether"), {
            from: seller
        });
        ...
        articleId = articlesForSale[1].toNumber();
